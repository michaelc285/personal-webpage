...
const MainContent = () => {
  return (
    <div className="container mx-auto ">
      <div className="py-40 px-10 sm:px-16 ">
        <h1 className="font-bold font-sans text-xl sm:text-5xl mb-3">
          Tell You More About Michael
        </h1>
        ...
        <br />
        <p className="text-left font-light font-sans text-xl sm:text-3xl mb-5">
          Strong time management, concentrate, communication skills developed
          during the time in internship and college.
        </p>
